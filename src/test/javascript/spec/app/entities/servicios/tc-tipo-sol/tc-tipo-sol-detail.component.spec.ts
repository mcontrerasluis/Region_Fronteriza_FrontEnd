...
import { TcTipoSolDetailComponent } from 'app/entities/servicios/tc-tipo-sol/tc-tipo-sol-detail.component';
import { TcTipoSol } from 'app/shared/model/servicios/tc-tipo-sol.model';
