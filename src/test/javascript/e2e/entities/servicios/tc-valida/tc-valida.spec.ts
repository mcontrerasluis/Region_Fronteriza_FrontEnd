...
describe('TcValida e2e test', () => {
  ...
  it('should load TcValidas', async () => {
    ...
    expect(await tcValidaComponentsPage.getTitle()).to.eq('fronterizaApp.serviciosTcValida.home.title');
  ...
  it('should load create TcValida page', async () => {
    ...
    expect(await tcValidaUpdatePage.getPageTitle()).to.eq('fronterizaApp.serviciosTcValida.home.createOrEditLabel');
  ...
  it('should delete last TcValida', async () => {
    ...
    expect(await tcValidaDeleteDialog.getDialogTitle()).to.eq('fronterizaApp.serviciosTcValida.delete.question');
