...
describe('TdGeneral e2e test', () => {
  ...
  it('should load TdGenerals', async () => {
    ...
    expect(await tdGeneralComponentsPage.getTitle()).to.eq('fronterizaApp.serviciosTdGeneral.home.title');
  ...
  it('should load create TdGeneral page', async () => {
    ...
    expect(await tdGeneralUpdatePage.getPageTitle()).to.eq('fronterizaApp.serviciosTdGeneral.home.createOrEditLabel');
  ...
  it('should delete last TdGeneral', async () => {
    ...
    expect(await tdGeneralDeleteDialog.getDialogTitle()).to.eq('fronterizaApp.serviciosTdGeneral.delete.question');
