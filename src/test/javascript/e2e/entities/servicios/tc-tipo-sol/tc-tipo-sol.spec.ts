...
describe('TcTipoSol e2e test', () => {
  ...
  it('should load TcTipoSols', async () => {
    ...
    expect(await tcTipoSolComponentsPage.getTitle()).to.eq('fronterizaApp.serviciosTcTipoSol.home.title');
  ...
  it('should load create TcTipoSol page', async () => {
    ...
    expect(await tcTipoSolUpdatePage.getPageTitle()).to.eq('fronterizaApp.serviciosTcTipoSol.home.createOrEditLabel');
  ...
  it('should delete last TcTipoSol', async () => {
    ...
    expect(await tcTipoSolDeleteDialog.getDialogTitle()).to.eq('fronterizaApp.serviciosTcTipoSol.delete.question');
