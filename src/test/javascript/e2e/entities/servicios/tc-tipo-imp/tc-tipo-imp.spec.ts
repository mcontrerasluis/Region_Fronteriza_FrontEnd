...
describe('TcTipoImp e2e test', () => {
  ...
  it('should load TcTipoImps', async () => {
    ...
    expect(await tcTipoImpComponentsPage.getTitle()).to.eq('fronterizaApp.serviciosTcTipoImp.home.title');
  ...
  it('should load create TcTipoImp page', async () => {
    ...
    expect(await tcTipoImpUpdatePage.getPageTitle()).to.eq('fronterizaApp.serviciosTcTipoImp.home.createOrEditLabel');
  ...
  it('should delete last TcTipoImp', async () => {
    ...
    expect(await tcTipoImpDeleteDialog.getDialogTitle()).to.eq('fronterizaApp.serviciosTcTipoImp.delete.question');
