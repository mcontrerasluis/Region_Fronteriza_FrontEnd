...
describe('TcEjerc e2e test', () => {
  ...
  it('should load TcEjercs', async () => {
    ...
    expect(await tcEjercComponentsPage.getTitle()).to.eq('fronterizaApp.serviciosTcEjerc.home.title');
  ...
  it('should load create TcEjerc page', async () => {
    ...
    expect(await tcEjercUpdatePage.getPageTitle()).to.eq('fronterizaApp.serviciosTcEjerc.home.createOrEditLabel');
  ...
  it('should delete last TcEjerc', async () => {
    ...
    expect(await tcEjercDeleteDialog.getDialogTitle()).to.eq('fronterizaApp.serviciosTcEjerc.delete.question');
