...
import sat.gob.mx.agsc.FronterizaApp;
...
import static sat.gob.mx.agsc.web.rest.TestUtil.ID_TOKEN;
import static sat.gob.mx.agsc.web.rest.TestUtil.authenticationToken;
 ...
 */
@SpringBootTest(classes = {FronterizaApp.class, TestSecurityConfiguration.class})
