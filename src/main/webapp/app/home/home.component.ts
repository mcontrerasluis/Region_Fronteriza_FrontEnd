...
export class HomeComponent implements OnInit {
  ...
  constructor(private accountService: AccountService, private loginService: LoginService, private menuService: MenuService, private primengConfig: PrimeNGConfig) {}
